...
module.exports = {
  ...
  resetErrorTimeoutToNeedGoogle() {
    return bookshelf.knex('routes')
      ...
      .update({
        googleStatus: 'restarted after Timeout',
        google_status: 'restarted after Timeout',
        state: `${Route.State.NEED_GOOGLE}`,
      })
      .then((numberOfRowRestarted) => console.log(` > Restarted ${numberOfRowRestarted} route calculations`));
  },
};
