...
function generatePayloadFromCSVRow(csvRow) {
  const address = {
    ...
    matchType: csvRow[CSV_HEADERS.MATCH_TYPE],
    matchedAddress: csvRow[CSV_HEADERS.MATCH_ADDRESS],
    latitude: csvRow[CSV_HEADERS.LATITUDE],
    longitude: csvRow[CSV_HEADERS.LONGITUDE],
  };
  return address;
}
...
function main() {
  ...
  console.log('\nScript Started');
  console.log('Update server data using csv');
